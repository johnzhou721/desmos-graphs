...
Unofficial fanart inspired by Disney's *Frozen* (2013).  The first link/``icepalace2.desmos`` is a newer iteration.  The older ones are archived.

(Note: $\frac{\mathrm d}{\mathrm dx}\tan x=\sec^2 x$ may explain some things.
